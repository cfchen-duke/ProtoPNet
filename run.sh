...
srun -u python main.py -latent=32 -experiment_run="PPNETSpiculated0415_spiculated_32" -base="resnet152"  \
                        -train_dir="/usr/project/xtmp/mammo/binary_Feb/binary_context_roi/binary_train_spiculated_noneg_augmented/" \
