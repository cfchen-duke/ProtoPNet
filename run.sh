...
srun -u python main.py -latent=256 -experiment_run="thresholdlogits0_spiculated_256_0423_with_normal" -base="vgg16"  \
                        -train_dir="/usr/project/xtmp/mammo/binary_Feb/binary_context_roi/binary_train_spiculated_augmented_morer_with_rot/" \
                        -push_dir="/usr/project/xtmp/mammo/binary_Feb/sorted_by_Fides_ratings/definite/" \
